...
public class Dbla
{
    ...
    public class Bot
    {
        ...
        [JsonPropertyName("defAvatar")] public string DefAvatar { get; set; }

        [JsonPropertyName("invite")] public string Invite { get; set; }
        ...
        [JsonPropertyName("server_count")] public ulong ServerCount { get; set; }

        [JsonPropertyName("shard_count")] public int ShardCount { get; set; }

        [JsonPropertyName("guilds")] public string[] Guilds { get; set; }

        [JsonPropertyName("shards")] public int[] Shards { get; set; }

        [JsonPropertyName("monthlyPoints")] public ulong MonthlyPoints { get; set; }

        [JsonPropertyName("points")] public ulong Points { get; set; }

        [JsonPropertyName("certifiedBot")] public bool CertifiedBot { get; set; }

        [JsonPropertyName("owners")] public string[] Owners { get; set; }

        [JsonPropertyName("tags")] public string[] Tags { get; set; }

        [JsonPropertyName("donatebotguildid")] public string Donatebotguildid { get; set; }
    }
}