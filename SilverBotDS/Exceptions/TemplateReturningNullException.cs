...
namespace SilverBotDS.Exceptions
{
    ...
    {
        public TemplateReturningNullException() : base()
        {
        }
        ...
        public TemplateReturningNullException(string template, Exception innerException) : base($"Assembly.GetExecutingAssembly().GetManifestResourceStream({template}) returned null", innerException)
        {
        }
    }
}